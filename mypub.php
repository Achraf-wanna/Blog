...
require('config.php');
require('class.php');
$errr = "<p id='ttt'>There is no post yet ! <a href='addpost.php'> Click here</a> to add your post </p>";
...
echo ' 
  <div class="blog-card alt flex">
    ...
    <div class="description" style="color:white";>
      <h2 style="color:#575fcf">'. $row["title"].' </h2>
      <h4>' . $_SESSION['username'].'</h4>
      <h4 style="color:#575fcf">'. $row["date"].'</h4>
      <p>' . $row["content"].'</p>
      <p class="read-more">
